...
OpenGLDrawable::OpenGLDrawable(bool doSquare)
{
	...
	if (doSquare == true)
	{
		...
		AddBind(std::unique_ptr<NoctalEngine::VertexBuffer>(NoctalEngine::Renderer::Instance().CreateVertexBuffer(vertices, sizeof(vertices), layout)));

		uint32_t indices[6] = { 0, 1, 2, 2, 3, 0 };
		AddIndexBuffer(std::unique_ptr<NoctalEngine::IndexBuffer>(NoctalEngine::Renderer::Instance().CreateIndexBuffer(indices, sizeof(indices) / sizeof(uint32_t))));
